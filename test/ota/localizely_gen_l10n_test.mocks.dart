...
import 'package:localazy_sdk/src/ota/model/label.dart' as _i3;
import 'package:localazy_sdk/src/ota/model/release_data.dart' as _i2;
...
class MockReleaseData extends _i1.Mock implements _i2.ReleaseData {
  ...
  @override
  int get version => (super.noSuchMethod(Invocation.getter(#version), returnValue: 0) as int);
  @override
  Map<String, Map<String, _i3.Label>> get data =>
      (super.noSuchMethod(Invocation.getter(#data), returnValue: <String, Map<String, _i3.Label>>{})
