import 'package:localazy_sdk/src/ota/parser/message_format.dart';
import 'package:localazy_sdk/src/ota/parser/parser.dart';
...
void main() {
  ...
  group('Argument messages', () {
    ...
    test('Test argument message with placeholder and plain text that contains different tags', () {
      var response =
          IcuParser().parse('<p>Argument <i>message</i> with <br/> <em>{placeholder}</em> and <b>tag</b>!</p><br>');
