...
class Store {
  ...
  static final String _appInstallationIdKey = 'LOCALIZELY_SDK_APP_INSTALLATION_ID';
  ...
  static Future<void> persistReleaseData(String distributionId, ReleaseData releaseData) async {
    try {
      var platform = Platform();

      var persistedReleaseData = PersistedReleaseData(distributionId, releaseData);
